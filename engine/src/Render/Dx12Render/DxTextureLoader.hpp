...
class DxTextureLoader {
  public:
    ...
    loadTextureFromFile(ID3D12Device *device, ID3D12GraphicsCommandList *commandList, const std::string &filename);

    static void loadImageDataFromFile(ID3D12Device *device, ID3D12GraphicsCommandList *commandList,
